...
# --- 接收 GitHub 界面手动输入的参数 ---
# INPUT_SEARCH_KEY 和 INPUT_CUSTOM_URL 是从 Actions 界面传进来的
...
if __name__ == "__main__":
    ...
    print(f"收割完成！关键词: {SEARCH_QUERY}, 共斩获 {len(nodes)} 个节点。")
